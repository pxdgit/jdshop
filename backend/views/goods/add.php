...
echo $form->field($model,'is_on_sale',['inline'=>1])->radioList(\backend\models\Goods::$allis_on_sale);
echo $form->field($model,'status',['inline'=>1])->radioList(\backend\models\ Goods::$allstatus);
